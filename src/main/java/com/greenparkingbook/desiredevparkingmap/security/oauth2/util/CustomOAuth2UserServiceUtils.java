package com.greenparkingbook.desiredevparkingmap.security.oauth2.util;

import com.greenparkingbook.desiredevparkingmap.exception.OAuth2AuthenticationProcessingException;
...
import com.greenparkingbook.desiredevparkingmap.security.oauth2.user.OAuth2UserInfo;
import com.greenparkingbook.desiredevparkingmap.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserServiceUtils {
    ...
    public CustomOAuth2UserServiceUtils(UserRepository userRepository) {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        OAuth2UserInfo oAuth2UserInfo =
                OAuth2UserInfoFactory.getOAuth2UserInfo(clientRegistrationId, oAuth2User.getAttributes());
